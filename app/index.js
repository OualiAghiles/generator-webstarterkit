...
module.exports = yeoman.generators.Base.extend({
  ...
  prompting: function () {
    ...
    // Have greet the user.
    this.log(yosay(
      'Welcome, let\'s generate a ' + chalk.blue('WebStarterKit') + ' A front-end architeture generator that helps you build fast, modern mobile and browser web apps.'
    ));
  ...
  writing: {
    ...
    projectfiles: function () {
      ...
      // Styles
      this.directory(
        this.templatePath('app/_stylesheets'),
        this.destinationPath('app/stylesheets')
      );
